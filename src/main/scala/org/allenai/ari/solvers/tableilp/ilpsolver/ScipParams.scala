...
/** Various parameters for the SCIP ILP solver
  ...
  * @param ilpExportFile if non-empty, filename to store the generated ILP for debugging purposes
...
class ScipParams @Inject() (
  ...
  @Named("scip.ilpExportFile") val ilpExportFile: String,
